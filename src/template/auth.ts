...
export const authPages: AuthPageContent[] = [
  {
    ...
    title: 'Login to your Blueprint workspace',
    description:
  ...
  },
  {
    ...
    title: 'Create a Blueprint trial workspace',
    description:
  ...
  },
  {
    ...
    title: 'Access the client workspace and reports',
    description:
