...
export const productPages = productSeed.map<MarketingPageContent>((product) => ({
  ...
  sourceUrl: `https://example.com${product.path}`,
  ...
  operationsIntro:
    'The page template mirrors the original site pattern: hero, feature proof, workflow blocks, outcomes, testimonials, FAQ, and conversion CTA.',
  operations: [
...
const featurePages: MarketingPageContent[] = [
  {
    ...
    sourceUrl: 'https://example.com/hospital-appointment-scheduling-software',
    visual: 'hospital',
    primaryCta: demoCta,
    secondaryCta: contactCta,
    ...
    features: [
      ...
      { title: 'Reminder-ready', description: 'SMS, email, and messaging reminder patterns are represented in the UI.', icon: MessageCircle },
    ],
  ...
  },
  {
    ...
    sourceUrl: 'https://example.com/hospital-emr-ehr-software',
    visual: 'security',
    primaryCta: demoCta,
    secondaryCta: contactCta,
    heroStats: sharedStats.slice(0, 3),
  ...
  },
  {
    ...
    sourceUrl: 'https://example.com/lab-sample-management-software',
    visual: 'lab',
    primaryCta: demoCta,
    secondaryCta: contactCta,
    heroStats: sharedStats.slice(0, 3),
...
const companyPages: MarketingPageContent[] = [
  {
    ...
    sourceUrl: 'https://example.com/best-healthcare-software-development-company',
    visual: 'people',
    primaryCta: demoCta,
    secondaryCta: contactCta,
    heroStats: sharedStats,
  ...
  },
  {
    ...
    sourceUrl: 'https://example.com/career-healthcare-information-management',
    visual: 'people',
  ...
  },
  {
    ...
    visual: 'people',
    primaryCta: demoCta,
    secondaryCta: { label: 'Email Sales', to: 'mailto:sales@blueprint.example', external: true },
    heroStats: [
  ...
  },
  {
    ...
    sourceUrl: 'https://example.com/partner-best-healthcare-solutions-provider',
    visual: 'growth',
    primaryCta: demoCta,
    secondaryCta: contactCta,
...
const resourcePages: MarketingPageContent[] = [
  {
    ...
    sourceUrl: 'https://example.com/book-demo-healthcare-management-software',
    visual: 'growth',
  ...
  },
  {
    ...
    description:
      'A brochure landing page with downloadable-resource framing, module overview, ratings, and conversion CTA.',
    sourceUrl: 'https://example.com/hospital-management-software-brochure',
    visual: 'growth',
    primaryCta: demoCta,
    secondaryCta: contactCta,
    heroStats: sharedStats.slice(0, 3),
    ...
    operationsIntro: 'Use this as a compact resource page for product families and implementation story.',
    operations: [
  ...
  },
  {
    ...
    sourceUrl: 'https://example.com/nabh-compliant-hospital-software-india',
    visual: 'security',
    primaryCta: demoCta,
    secondaryCta: contactCta,
    heroStats: [
  ...
  },
  {
    ...
    sourceUrl: 'https://example.com/pmjay-integrated-hospital-software',
    visual: 'integration',
    primaryCta: demoCta,
    secondaryCta: contactCta,
    heroStats: [
    ...
    operationsIntro: 'This route uses the resource template and can be extended with real implementation rules later.',
    operations: operationalFeatures,
  ...
  },
  {
    ...
    operationsIntro: 'This is not legal advice and intentionally avoids copying the source site terms.',
    operations: [
    ...
    outcomes: [
      ...
      { value: 'Original', label: 'No copied terms' },
  ...
  },
  {
    ...
    sourceUrl: 'https://example.com/terms-of-use',
    visual: 'security',
    primaryCta: demoCta,
    secondaryCta: contactCta,
    heroStats: [
      { value: 'Terms', label: 'Website usage' },
      { value: 'Original', label: 'No copied source terms' },
...
const customerPages: MarketingPageContent[] = [
  {
    ...
    sourceUrl: 'https://example.com/customers-review',
    visual: 'people',
    primaryCta: demoCta,
    secondaryCta: contactCta,
    heroStats: sharedStats,
  ...
  },
  {
    ...
    sourceUrl: 'https://example.com/success-stories',
    visual: 'growth',
    primaryCta: demoCta,
    secondaryCta: contactCta,
    heroStats: sharedStats,
  ...
  },
  {
    ...
    sourceUrl: 'https://example.com/referral-program-healthcare-professionals',
    visual: 'growth',
    primaryCta: demoCta,
    secondaryCta: contactCta,
    heroStats: [
